...
//If you have a compilation error here then you have to uploadPhoto a reference to ExKsoap2.jar to your project (you can find it in Libs folder in the generated zip file)
public class GSPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GSPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GSPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GSPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GSPDateTimeConverter dateTimeConverter = new GSPStandardDateTimeConverter();

    public GSPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GSPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GSPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GSPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GSPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GSPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
