...
public class IRIKPSPublicSoap
{
    ...
    public IRIKPSPublicSoap(){}

    public IRIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IRIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IRIExtendedSoapSerializationEnvelope envelope= new IRIExtendedSoapSerializationEnvelope(IRIExtendedSoapSerializationEnvelope.VER11);
