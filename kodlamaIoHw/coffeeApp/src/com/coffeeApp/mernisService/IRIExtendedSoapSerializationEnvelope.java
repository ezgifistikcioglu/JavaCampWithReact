...
public class IRIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IRIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IRIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IRIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IRIDateTimeConverter dateTimeConverter = new IRIStandardDateTimeConverter();

    public IRIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IRIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IRIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IRIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IRIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IRIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
